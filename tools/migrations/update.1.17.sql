...
(27, 40, 5, 1, 0, 'Club Gifts', '', 'Club Gifts', 'ctlg_layout2', 'catalog_club_headline1', 'catalog_hc_teaser,', 'Welcome to the Club Shop! All \'Habbo Club membership gifts\' are available here, use them wisely you greedy cunt! We have sofas, butlers and all the happy stuff.', 'Click on the item you want for more information', NULL, NULL),
...
(81, 29, 1, 1, 0, 'Grunge', '', 'Grunge', 'ctlg_layout2', 'catalog_gru_headline1', 'catalog_gru_teaser', 'The Grunge range will get your bedroom looking just the way you like it - organised, neat and tidy!', 'Click on the item you want for more information', NULL, ''),
(84, 29, 1, 1, 0, 'How to make music?', '', 'How to make music?', 'ctlg_soundmachine', 'catalog_djshop_headline1', 'catalog_djshop_teaser1', 'You must own a trax machine and at least one trax pax. Place the trax machine in your room and the trax pax in your hand. Double click the trax machine, click \"Trax editor\" and start editing music. When ready, save, select the tune, turn on the trax machine and enjoy.', 'Cool, my own music!', NULL, ''),
