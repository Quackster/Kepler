package net.h4bbo.kepler.game.badges;

import net.h4bbo.kepler.dao.mysql.BadgeDao;
import net.h4bbo.kepler.game.player.Player;
import net.h4bbo.kepler.messages.outgoing.rooms.badges.AVAILABLE_BADGES;
import net.h4bbo.kepler.messages.outgoing.user.badges.ACHIEVEMENT_NOTIFICATION;
