package net.h4bbo.kepler.messages;

import net.h4bbo.kepler.game.player.Player;
import net.h4bbo.kepler.game.room.Room;
import net.h4bbo.kepler.game.room.RoomManager;
import net.h4bbo.kepler.log.Log;
import net.h4bbo.kepler.messages.incoming.catalogue.GCAP;
import net.h4bbo.kepler.messages.incoming.catalogue.GCIX;
import net.h4bbo.kepler.messages.incoming.catalogue.GET_ALIAS_LIST;
import net.h4bbo.kepler.messages.incoming.catalogue.GRPC;
import net.h4bbo.kepler.messages.incoming.club.GET_CLUB;
import net.h4bbo.kepler.messages.incoming.club.SCR_GIFT_APPROVAL;
import net.h4bbo.kepler.messages.incoming.club.SUBSCRIBE_CLUB;
import net.h4bbo.kepler.messages.incoming.events.*;
import net.h4bbo.kepler.messages.incoming.games.*;
import net.h4bbo.kepler.messages.incoming.handshake.GENERATEKEY;
import net.h4bbo.kepler.messages.incoming.handshake.INIT_CRYPTO;
import net.h4bbo.kepler.messages.incoming.handshake.SSO;
import net.h4bbo.kepler.messages.incoming.handshake.TRY_LOGIN;
import net.h4bbo.kepler.messages.incoming.infobus.CHANGEWORLD;
import net.h4bbo.kepler.messages.incoming.infobus.TRYBUS;
import net.h4bbo.kepler.messages.incoming.infobus.VOTE;
import net.h4bbo.kepler.messages.incoming.inventory.GETSTRIP;
import net.h4bbo.kepler.messages.incoming.jukebox.*;
import net.h4bbo.kepler.messages.incoming.messenger.*;
import net.h4bbo.kepler.messages.incoming.moderation.*;
import net.h4bbo.kepler.messages.incoming.navigator.*;
import net.h4bbo.kepler.messages.incoming.pets.GETPETSTAT;
import net.h4bbo.kepler.messages.incoming.purse.GETUSERCREDITLOG;
import net.h4bbo.kepler.messages.incoming.purse.REDEEM_VOUCHER;
import net.h4bbo.kepler.messages.incoming.recycler.CONFIRM_FURNI_RECYCLING;
import net.h4bbo.kepler.messages.incoming.recycler.GET_FURNI_RECYCLER_CONFIGURATION;
import net.h4bbo.kepler.messages.incoming.recycler.GET_FURNI_RECYCLER_STATUS;
import net.h4bbo.kepler.messages.incoming.recycler.START_FURNI_RECYCLING;
import net.h4bbo.kepler.messages.incoming.register.*;
import net.h4bbo.kepler.messages.incoming.rooms.*;
import net.h4bbo.kepler.messages.incoming.rooms.badges.SETBADGE;
import net.h4bbo.kepler.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_CHANGE_STATE;
import net.h4bbo.kepler.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_GET_PRESETS;
import net.h4bbo.kepler.messages.incoming.rooms.dimmer.MSG_ROOMDIMMER_SET_PRESET;
import net.h4bbo.kepler.messages.incoming.rooms.items.*;
import net.h4bbo.kepler.messages.incoming.rooms.moderation.*;
import net.h4bbo.kepler.messages.incoming.rooms.pool.*;
import net.h4bbo.kepler.messages.incoming.rooms.settings.*;
import net.h4bbo.kepler.messages.incoming.rooms.teleporter.GETDOORFLAT;
import net.h4bbo.kepler.messages.incoming.rooms.user.*;
import net.h4bbo.kepler.messages.incoming.songs.*;
import net.h4bbo.kepler.messages.incoming.trade.*;
import net.h4bbo.kepler.messages.incoming.tutorial.*;
import net.h4bbo.kepler.messages.incoming.user.*;
import net.h4bbo.kepler.messages.incoming.user.badges.GETAVAILABLEBADGES;
import net.h4bbo.kepler.messages.incoming.user.badges.GETSELECTEDBADGES;
import net.h4bbo.kepler.messages.incoming.user.settings.GET_ACCOUNT_PREFERENCES;
import net.h4bbo.kepler.messages.incoming.user.settings.GET_SOUND_SETTING;
import net.h4bbo.kepler.messages.incoming.user.settings.UPDATE_ACCOUNT;
import net.h4bbo.kepler.messages.incoming.welcomingparty.ACCEPT_TUTOR_INVITATION;
import net.h4bbo.kepler.messages.incoming.welcomingparty.REJECT_TUTOR_INVITATION;
import net.h4bbo.kepler.messages.incoming.wobblesquabble.PTM;
import net.h4bbo.kepler.messages.outgoing.rooms.groups.GROUP_BADGES;
import net.h4bbo.kepler.messages.outgoing.rooms.groups.GROUP_INFO;
